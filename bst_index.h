...
#ifndef HERMESDB_BST_INDEX
#define HERMESDB_BST_INDEX
...
class BSTIndex : public Index {
 ...
 private:
  ...
  struct Entry {
    ...
    index_t index_entry_left;
    index_t index_entry_right;
  };
  ...
  char* classname() { return "BSTIndex"; }
};

};

#endif // HERMESDB_BST_INDEX
